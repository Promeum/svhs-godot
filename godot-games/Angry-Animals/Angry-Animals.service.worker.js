...
/** @type {string} */
const CACHE_VERSION = '1738969951|171564981';
/** @type {string} */
const CACHE_PREFIX = 'Angry Animals-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Angry-Animals.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Angry-Animals.html","Angry-Animals.js","Angry-Animals.offline.html","Angry-Animals.icon.png","Angry-Animals.apple-touch-icon.png","Angry-Animals.worker.js","Angry-Animals.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Angry-Animals.wasm","Angry-Animals.pck"];
