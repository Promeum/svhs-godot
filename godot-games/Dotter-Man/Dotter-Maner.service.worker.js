...
/** @type {string} */
const CACHE_VERSION = '1739548870|2042882850';
/** @type {string} */
const CACHE_PREFIX = 'Dotter-Maner-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Dotter-Maner.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Dotter-Maner.html","Dotter-Maner.js","Dotter-Maner.offline.html","Dotter-Maner.icon.png","Dotter-Maner.apple-touch-icon.png","Dotter-Maner.worker.js","Dotter-Maner.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Dotter-Maner.wasm","Dotter-Maner.pck"];
