...
/** @type {string} */
const CACHE_VERSION = '1738942189|256960279';
/** @type {string} */
const CACHE_PREFIX = 'VikingRaiderGame-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'VikingRaiderGameLTS1_1.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["VikingRaiderGameLTS1_1.html","VikingRaiderGameLTS1_1.js","VikingRaiderGameLTS1_1.offline.html","VikingRaiderGameLTS1_1.icon.png","VikingRaiderGameLTS1_1.apple-touch-icon.png","VikingRaiderGameLTS1_1.worker.js","VikingRaiderGameLTS1_1.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["VikingRaiderGameLTS1_1.wasm","VikingRaiderGameLTS1_1.pck"];
